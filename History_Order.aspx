<%@ Page Title="Order History :: BBD" Language="C#" MasterPageFile="~/Account/MasterPage.master" AutoEventWireup="true" CodeFile="History_Order.aspx.cs" Inherits="Account_charts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="about">
        <div class="container">
            <h3 class="w3ls-title w3ls-title1">Order History</h3>
                                    ...
                                    <div class="switch-right-grid1">
                                        ...
                                        <table style="width: 100%; background-color: #f5eded">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 33.3%">
                                                    <br />
                                                    <t style="font-size: medium"><b>&nbsp;&nbsp;Status :</b></t>
                                                    <asp:HiddenField ID="hfStatus" runat="server" Value='<%# Eval("Status") %>' />

                                                    <asp:Label ID="lblStatus" Style="font-size: medium; color: red; font-weight: bold" runat="server" Text='  <%# Eval("Status") %>' />
                                                </td>
                                        ...
                                        <table style="background-color: lightgrey; width: 100%">
                                            ...
                                            <tr>
                                                <td style="text-align: left">&nbsp;&nbsp;<asp:LinkButton ID="lnkDelete" runat="server" OnClientClick="return confirm('Do you want to cancel this Bag?');"
                                                    OnClick="CancelBag"><img src="../images/cancel.png" alt="Cancel "/></asp:LinkButton></td>
                                                <td style="text-align: right">
                                                    <t style="font-size: large"><b>&nbsp;&nbsp;Payable Amount:</b></t>
                                                    <t style="font-size: large">&nbsp;&nbsp;<%#Eval("TotalSum") %></t>
                                                    &nbsp;&nbsp;
