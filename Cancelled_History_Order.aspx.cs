...
public partial class Account_charts : System.Web.UI.Page
{
   // SqlConnection c = new SqlConnection("Data Source= 199.79.62.22;Initial Catalog=DhabaDB; User Id=DhabaSA; Password=Abc123$*");
    ...
    {
        SqlCommand cmd12 = new SqlCommand("Select * from Bag where UserId='" + Session["user"].ToString() + "' and Status = 'Cancelled' and Status != 'Adding Item' and Status !='Order Placed' order by Date desc", c);
    ...
    private static DataTable GetData(string query)
    {
        ...
        using (SqlConnection con = new SqlConnection("Data Source= 199.79.62.22;Initial Catalog=DhabaDB; User Id=DhabaSA; Password=Abc123$*"))
        {
